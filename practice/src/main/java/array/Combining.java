...
public class Combining {
	public static void main(String[] args) {
		...
		//we will subtract the value by 50. 
		//Remember that the value range for the pixel is 0-255, 
